...
//    private static final Dimension CHESSGRID_SIZE = new Dimension(1080 / 4 * 3 / 8, 1080 / 4 * 3 / 8);
    ...
    public abstract List<ChessboardPoint> points(ChessComponent[][] chessComponents);
...
/*
* 下为新增内容
* canBeMovedTo表示该Component是被选中的棋子的可以去的点，1为在list里，0为不在list里
* 在每一个具体的棋子里都有setCanBeMovedTo的方法
* 问题出在set完仍然为0，所以不会进行到下面的程序，可前往的地点不会变色
* */
        if (canBeMovedTo == 1) {
